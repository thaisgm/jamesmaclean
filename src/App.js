    ...
    <div>
      <div className="firstContainer">
        ...
        <MDBView className="tile" hover zoom>
          ...
          <div>
            <h2 className="blue-text">UMD Pride Campaign</h2>
          ...
          <MDBView className="tile" hover zoom>
            ...
            <MDBMask className="flex-center" overlay="white-strong">
            <div>
              <h2 className="blue-text">Stan Lee Productions</h2>
              <LinkContainer to="/stanlee"><Button variant="link">View the Project</Button></LinkContainer>
            </div>
            </MDBMask>
          </MDBView>
          <MDBView className="tile" hover zoom>
            ...
            <MDBMask className="flex-center" overlay="white-strong">
            <div>
              <h2 className="blue-text">Home Shopping Network</h2>
        ...
        <MDBView className="tile" hover zoom>
          ...
          <MDBMask className="flex-center" overlay="white-strong">
          <div>
            <h2 className="blue-text">Swagger Magazine</h2>
        ...
        <MDBView className="tile" hover zoom>
          ...
          <MDBMask className="flex-center" overlay="white-strong">
          <div>
            <h2 className="blue-text">Awards Shows</h2>
        ...
        <MDBView className="tile" hover zoom>
          ...
          <MDBMask className="flex-center" overlay="white-strong">
          <div>
            <h2 className="blue-text">Comic Con</h2>
